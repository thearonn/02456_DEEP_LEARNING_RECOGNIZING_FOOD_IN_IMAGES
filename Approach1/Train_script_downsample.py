...
# Run with pos-weights
#from LoadData_ny import Data_train
#from LoadData_ny import Data_val
#from LoadData_ny import Data_test

# Run with downsampling
from Class_imbalance import Data_train_modified
from Class_imbalance import Data_val_modified
from Class_imbalance import Data_test_modified

from LoadData_ny import categories, Classes
from NetAdvanced_ny import Net 
from NetAdvanced_ny import opt
from NetAdvanced_ny import criterion
...
#--------------------------------------------------------------
train_loader = torch.utils.data.DataLoader(Data_train_modified, batch_size=batch_size,shuffle=True,drop_last=True)
val_loader = torch.utils.data.DataLoader(Data_val_modified,batch_size=batch_size,shuffle=True,drop_last=True)
...
test_loader = torch.utils.data.DataLoader(Data_test_modified, batch_size=batch_size,shuffle=True,drop_last=True)
